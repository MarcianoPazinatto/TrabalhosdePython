...
class ClienteDao:
    ...
    def inserir(self, cliente : ClienteModel):
        self.cursor.execute("INSERT INTO TABELA_CLIENTES(NOME,SOBRENOME,IDADE, SEXO) VALUES ('{}','{}',{},'{}'".format(cliente.nome,cliente.sobrenome, cliente.idade))
